...
class MutualExclusionIf {
 public:
  ...
  virtual void request(const int32_t procID) = 0;
  virtual void release(const int32_t procID) = 0;
};
...
typedef struct _MutualExclusion_request_args__isset {
  _MutualExclusion_request_args__isset() : procID(false) {}
  bool procID :1;
} _MutualExclusion_request_args__isset;
...
class MutualExclusion_request_args {
 public:
  ...
  MutualExclusion_request_args() : procID(0) {
  }

  virtual ~MutualExclusion_request_args() throw();
  int32_t procID;

  _MutualExclusion_request_args__isset __isset;

  void __set_procID(const int32_t val);
...
typedef struct _MutualExclusion_release_args__isset {
  _MutualExclusion_release_args__isset() : procID(false) {}
  bool procID :1;
} _MutualExclusion_release_args__isset;
...
class MutualExclusion_release_args {
 public:
  ...
  MutualExclusion_release_args() : procID(0) {
  }

  virtual ~MutualExclusion_release_args() throw();
  int32_t procID;

  _MutualExclusion_release_args__isset __isset;
...
class MutualExclusionClient : virtual public MutualExclusionIf {
 ...
 public:
  ...
  void request(const int32_t procID);
  void send_request(const int32_t procID);
  void recv_request();
  void release(const int32_t procID);
  void send_release(const int32_t procID);
  void recv_release();
 protected:
...
class MutualExclusionConcurrentClient : virtual public MutualExclusionIf {
 ...
 public:
  ...
  void request(const int32_t procID);
  int32_t send_request(const int32_t procID);
  void recv_request(const int32_t seqid);
  void release(const int32_t procID);
  int32_t send_release(const int32_t procID);
